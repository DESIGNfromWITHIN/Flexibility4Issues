...
1. Download and install Flexibility 4 from the MODX package manager.
...
2. download the package and upload the "flexibility-0.0.1-rc.transport.zip" file to "<your_modx_install>/core/packages/" (You only need the transport.zip file, do not unzip it yourself)
